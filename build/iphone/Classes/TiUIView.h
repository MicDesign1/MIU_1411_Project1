...
/**
 Base class for all MIU_1411_Project1 views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the MIU_1411_Project1 view hierarchy (such as wrapped iOS UIViews) was touched.
