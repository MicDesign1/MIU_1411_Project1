...
//@interface MIU_1411_Project1Object : NSObject
//@end

@interface MIU_1411_Project1Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[MIU_1411_Project1Object class]])
		{
			for (NSString *key in [[(MIU_1411_Project1Object*)o modules] allKeys])
			{
