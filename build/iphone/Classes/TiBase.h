...
// in simulator we redefine to format for MIU_1411_Project1 Developer console
...
{\
	NSString * exceptionName = [@"org.miu_1411_project1." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.miu_1411_project1";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIMIU_1411_Project1NativeItemNone = -1, 
	UIMIU_1411_Project1NativeItemSpinner = -2,
	UIMIU_1411_Project1NativeItemProgressBar = -3,
	
	UIMIU_1411_Project1NativeItemSlider = -4,
	UIMIU_1411_Project1NativeItemSwitch = -5,
	UIMIU_1411_Project1NativeItemMultiButton = -6,
	UIMIU_1411_Project1NativeItemSegmented = -7,
	
	UIMIU_1411_Project1NativeItemTextView = -8,
	UIMIU_1411_Project1NativeItemTextField = -9,
	UIMIU_1411_Project1NativeItemSearchBar = -10,
	
	UIMIU_1411_Project1NativeItemPicker = -11,
	UIMIU_1411_Project1NativeItemDatePicker = -12,
	
	UIMIU_1411_Project1NativeItemInfoLight = -13,
	UIMIU_1411_Project1NativeItemInfoDark = -14,
	
	UIMIU_1411_Project1NativeItemDisclosure = -15,
	
	UIMIU_1411_Project1NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all MIU_1411_Project1 instances of
