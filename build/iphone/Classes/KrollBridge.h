...
@interface MIU_1411_Project1Object : KrollCoverageObject {
#else
@interface MIU_1411_Project1Object : KrollObject {
#endif
@private
...
extern NSString * MIU_1411_Project1$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	MIU_1411_Project1Object *_miu_1411_project1;
    KrollObject* console;
	BOOL shutdown;
